...
public interface VtDirect extends VtGateway {
     ...
     * @param vtDirectChargeRequest Veritrans charging message request. {@link id.co.veritrans.mdk.gateway.model.vtdirect.CreditCardRequest Credit card request}, {@link id.co.veritrans.mdk.gateway.model.vtdirect.BankTransferRequest bank transfer request}, {@link id.co.veritrans.mdk.gateway.model.vtdirect.MandiriClickpayRequest mandiri clickpay request}. {@link id.co.veritrans.mdk.gateway.model.vtdirect.CimbClicksRequest cimb clicks request}, or {@link id.co.veritrans.mdk.gateway.model.vtdirect.BriEpayRequest bri epay request}.
