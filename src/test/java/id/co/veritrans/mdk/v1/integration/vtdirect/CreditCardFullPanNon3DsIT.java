 ...
 */
public class CreditCardFullPanNon3DsIT extends AbstractCreditCardIT {
    ...
    public void testCharge() throws RestClientException, URISyntaxException {
        final VtResponse vtResponse = charge(orderId, new CreditCardFullPan("5410111111111116", "123", "01", "2020"));
